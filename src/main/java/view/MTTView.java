...
public class MTTView extends javax.swing.JFrame {
    ...
    private void loadTable() {
        ...
        for (MONTHETHAO cv : mtts.getListMTT()) {
            defaultTableModel.addRow(new Object[]{
                cv.getMAMTT(), cv.getTENMTT(), cv.getNGAYTAO(), cv.getNGAYSUA(), cv.getTRANGTHAI()== 1 ? "Hoạt Động" : "Không Hoạt Động"
            });
        }
    }
    ...
    private MONTHETHAO getForm() {
        String tenCV = txtTenMTT.getText().trim();
    ...
    private void initComponents() {
        ...
        txtTenMTT = new javax.swing.JTextField();
        txtNgayTao = new javax.swing.JTextField();
        txtNgaySua = new javax.swing.JTextField();
        lb_MaMTT = new javax.swing.JLabel();
        ...
        jLabel1.setText("Quản Lý Môn Thể Thao");

        jLabel2.setText("Tên MTT");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(58, 58, 58)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtTenMTT)
                            .addComponent(txtNgaySua)
                            .addComponent(txtNgayTao)
                            .addComponent(lb_MaMTT, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtTenMTT, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnSua))))
                .addGap(9, 9, 9)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        String traLoi = mtts.updateMTT(cv, ID);
        loadTable();
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        String id = tbChucVu.getValueAt(row, 0).toString();
        int ID = (Integer.parseInt(id));
        String traLoi = mtts.deleteMTT(ID);
        loadTable();
        JOptionPane.showMessageDialog(this, traLoi);
    ...
    private void tbChucVuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbChucVuMouseClicked
        int row = tbChucVu.getSelectedRow();
        lb_MaMTT.setText(tbChucVu.getValueAt(row, 0).toString());
        txtTenMTT.setText(tbChucVu.getValueAt(row, 1).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MTTView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
